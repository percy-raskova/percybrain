  ...
  describe("Plugin Configuration", function()
    ...
    it("respects lazy loading configuration", function()
      ...
      assert.is_true(lazy_count > immediate_count,
        string.format("Too many immediate plugins: %d immediate, %d lazy",
                      immediate_count, lazy_count))
    end)
  end)
  ...
  describe("Performance Characteristics", function()
    it("loads within reasonable time", function()
      ...
      assert.is_true(elapsed < 0.1,
        string.format("Config load too slow: %.3fs", elapsed))
    end)
    ...
    it("doesn't leak global variables", function()
      ...
      assert.equals(0, #after,
        "Config leaked globals: " .. table.concat(after, ", "))
    end)
  end)
end)