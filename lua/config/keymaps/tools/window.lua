...
local keymaps = {
  ...
  },
  {
    ...
    function()
      vim.cmd("wincmd J")
      vim.notify("🪟 Window moved J", vim.log.levels.INFO)
    end,
  ...
  },
  {
    ...
    function()
      vim.cmd("wincmd K")
      vim.notify("🪟 Window moved K", vim.log.levels.INFO)
    end,
    desc = "⇑ Move window up",
  },
  {
    ...
    function()
      vim.cmd("wincmd L")
      vim.notify("🪟 Window moved L", vim.log.levels.INFO)
    end,
  ...
  -- Closing
  {
    "<leader>wc",
    function()
      require("config.window-manager").close_window()
    end,
    desc = "❌ Close window",
  },
  {
  ...
  },
  {
    ...
    desc = "⬅️ Previous buffer",
  },
  {
    "<leader>wd",
    function()
      require("config.window-manager").delete_buffer()
    end,
  ...
  -- Layout presets
  {
    "<leader>wW",
    function()
      require("config.window-manager").layout_wiki()
    end,
    desc = "📚 Wiki workflow layout",
  },
  {
    "<leader>wF",
    function()
      require("config.window-manager").layout_focus()
    end,
    desc = "✍️ Focus layout",
  },
  {
    "<leader>wR",
    function()
      require("config.window-manager").layout_reset()
    end,
    desc = "🔄 Reset layout",
  },
  {
    "<leader>wG",
    function()
      require("config.window-manager").layout_research()
    end,
    desc = "🔬 Research layout",
  },
  ...
  -- Info
  {
    "<leader>wi",
    function()
      require("config.window-manager").window_info()
    end,
    desc = "ℹ️  Window info",
  },
}
